...
// zhou: this file is generated by client-gen for k8s native resource, it's same as CRD if
//
//	client-gen enabled.
package kubernetes
...
// zhou: define interface to support each native GVK.
...
// zhou: get discovery client from clientset.
