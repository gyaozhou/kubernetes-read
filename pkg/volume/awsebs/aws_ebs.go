...
// zhou: it's a in-tree volume plugin.
//       The EBS CSI driver provisioner is "ebs.csi.aws.com".
const (
...
// zhou: just record the handler to access host.
...
// zhou: in-tree PV or in-tree Pod volume
